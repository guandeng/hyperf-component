...
use HyperfComponent\Agent\Exceptions\BadMethodCallException;
...
class Agent extends MobileDetect
{
     ...
     * Get the device type.
     */
    public function deviceType(?string $userAgent = null, ?string $httpHeaders = null): string
    {
    ...
    public function version($propertyName, $type = self::VERSION_TYPE_STRING): bool
    {
